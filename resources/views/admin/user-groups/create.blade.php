                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 input-field">
                                        <input type="text" name="groupName" id="groupName" class="form-control" required value="{!! Input::old('groupName') !!}"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 input-field">
                                        ...
                                        <div class="row row-top-margin" id="permission-list">
                                            ...
                                            @foreach($permsList as $index=>$perm)
                                                <div class="col-sm-4 ">
                                                    <div class="checkbox">
                                                    <input type="checkbox" value="{!! $perm->getPermission() !!}" name="perms[{!! $perm->getId() !!}]" id="perms_{!! $perm->getId() !!}" title="{!! $perm->getDescription() !!}"> {!! $perm->getPermission() !!}
                                                    </div>
                                                </div>
                                            @endforeach
                                                 </div>
