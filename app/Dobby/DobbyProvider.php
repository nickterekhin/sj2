...
class DobbyProvider extends ServiceProvider
{
    ...
    protected function registerUserProvider()
    {
        ...
        $this->app->bind('App\Dobby\ModelProviders\IUsers','App\Dobby\ModelProviders\Impl\UsersModelImpl');
        $this->app->bind('App\Dobby\ModelProviders\IUserGroups','App\Dobby\ModelProviders\Impl\UserGroupModelImpl');
