...
namespace {
    ...
    class Dobby extends \App\Dobby\DobbyFacade{
        ...
        public static function initUser(){
            return \App\Dobby\Dobby::initUser();
        }
         ...
         * @static 
         */
        public static function login($credential, $remember = false){
            return \App\Dobby\Dobby::login($credential, $remember);
        }
